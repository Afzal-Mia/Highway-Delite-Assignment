...
const transporter = nodemailer.createTransport({
  service: 'gmail', 
  auth: {
    user: 'ansarahemad1220@gmail.com', 
    pass: 'xtjcmnwzzdpgaksi',
  },
});
...
const sendOTP = (userName,userEmail,otp)  => {
  ...
  let mailOptions = {
    from: 'ansarahemad1220@gmail.com',
    to: userEmail,
...
<body>
  <div class="container">
      ...
      <div class="content">
          ...
          <p>This OTP is valid for only 5 minutes. Please do not share it with anyone.</p>
      </div>
      <div class="footer">
